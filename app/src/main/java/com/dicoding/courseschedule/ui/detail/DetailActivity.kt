...
class DetailActivity : AppCompatActivity() {
    ...
    private fun showCourseDetail(course: Course?) {
        course?.apply {
            ...
            val name: TextView = findViewById(R.id.tv_course_name)
            val lectureName: TextView = findViewById(R.id.tv_lecturer)
            val time: TextView = findViewById(R.id.tv_time)
            val courseNote: TextView = findViewById(R.id.tv_note)

            name.text = courseName
            lectureName.text = lecturer
